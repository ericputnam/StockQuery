// Setting up the Database for the StockQuery application, including the indexes
...
function bootstrap() {
  ...
  checkForAppServer(restConfig)
    ...
    .then(function() {
      ...
      return applyConfig('/manage/v2/databases/stockquery-content/properties', 'PUT', dbConfig);
    })
    .catch(
      function (error) {
